 ...
 * Navegación con contexto: pasa los IDs de todos los alojamientos
 * visibles como query param para habilitar flechas prev/next en el detalle.
 */
@Component({
...
export class AlojamientoCardComponent {
  ...
  get calificacionLabel(): string {
    return this.totalResenas > 0 ? this.calificacion.toFixed(1) : 'Nuevo';
  }
